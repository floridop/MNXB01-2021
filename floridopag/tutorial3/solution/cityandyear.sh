...
########################################################################
# 
# cityandyear.sh - MNXB01-2021 Homework 3
#
...
CITYFILE=$(grep -il $CITY $DATAPATH/*)
...
# If the city is found we print out the path
...
# Now we can run the smhicleaner.sh script on the file to extract some
# data
...
./smhicleaner.sh $CITYFILE &> smhicleaner.log
...
# If the filename above has been correctly found, we can rewrite the content
